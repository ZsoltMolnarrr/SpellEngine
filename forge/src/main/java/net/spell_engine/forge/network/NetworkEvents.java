...
import net.minecraftforge.network.event.RegisterConfigurationTasksEvent;
...
@Mod.EventBusSubscriber(modid = SpellEngineMod.ID, bus = Mod.EventBusSubscriber.Bus.MOD)
