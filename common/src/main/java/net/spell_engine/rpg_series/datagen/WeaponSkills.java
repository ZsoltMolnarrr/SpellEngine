...
public class WeaponSkills {
    ...
    private static Entry whirlwind() {
        var id = new Identifier(NAMESPACE, "whirlwind");
        var title = "Whirlwind";
    ...
    private static Entry CLEAVE() {
        var id = new Identifier(NAMESPACE, "cleave");
        var title = "Cleave";
    ...
    private static Entry GROUND_SLAM() {
        var id = new Identifier(NAMESPACE, "ground_slam");
    ...
    private static Entry SMASH() {
        var id = new Identifier(NAMESPACE, "smash");
        var title = "Smash";
    ...
    private static Entry FLURRY() {
        var id = new Identifier(NAMESPACE, "flurry");
        var title = "Flurry";
...
//        SpellBuilder.Casting.cast(spell, 1F);
    ...
    private static Entry SWIFT_STRIKES() {
        var id = new Identifier(NAMESPACE, "swift_strikes");
    ...
    private static Entry IMPALE() {
        var id = new Identifier(NAMESPACE, "impale");
        var title = "Impale";
    ...
    private static Entry FAN_OF_KNIVES() {
        var id = new Identifier(NAMESPACE, "fan_of_knives");
    ...
    private static Entry THRUST() {
        var id = new Identifier(NAMESPACE, "thrust");
        var title = "Thrust";
    ...
    private static Entry SWIPE() {
        var id = new Identifier(NAMESPACE, "swipe");
        var title = "Swipe";
