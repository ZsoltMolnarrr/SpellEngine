...
import net.spell_engine.api.spell.SpellAssignment;
...
public class SpellRegistry {
    ...
    private static void printHardCoded() {
        ...
        fireBall.cast.animation = "spell_engine:one_handed_projectile_charge";
        fireBall.cast.sound = new Sound("spell_engine:casting_fire");
        ...
        fireBall.on_release.sound = new Sound("spell_engine:release_fire");
        fireBall.on_release.animation = "spell_engine:one_handed_projectile_release";
        ...
        firballImpact.sound = new Sound("spell_engine:impact_fireball");
        ...
        frostbolt.cast.animation = "spell_engine:one_handed_projectile_charge";
        frostbolt.cast.sound = new Sound("spell_engine:casting_frost");
        ...
        frostbolt.on_release.animation = "spell_engine:one_handed_projectile_release";
        frostbolt.on_release.sound = new Sound("spell_engine:release_frost");
        ...
        frostboltImpact.sound = new Sound("spell_engine:impact_frostbolt");
