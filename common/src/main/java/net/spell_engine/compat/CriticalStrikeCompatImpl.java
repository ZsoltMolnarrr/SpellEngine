...
public class CriticalStrikeCompatImpl {
...
//            });
    ...
    public static Predicate<DamageSource> isCriticalStrikePredicate() { return isCriticalStrike; }
    public static BiConsumer<DamageSource, Float> setCriticalStrikeConsumer() { return setCriticalStrike; }
